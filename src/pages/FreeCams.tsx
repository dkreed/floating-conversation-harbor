    ...
    <div className="min-h-screen bg-background relative">
      ...
      <section className="pt-24 pb-16 px-4 md:px-8 max-w-4xl mx-auto relative z-10">
        ...
        <div className="glass-panel rounded-xl p-8 mb-8">
          <h1 className="text-3xl md:text-4xl font-bold mb-6 gradient-text">Top Free Cams Reviewed</h1>
          
          <div className="space-y-6 text-muted-foreground">
            <p className="text-lg">Our detailed reviews of the top free webcam services available online.</p>
